...
class Ballot(google.protobuf.message.Message):
    ...
    @property
    def responses(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[response_pb2.Response]: ...
    signature: builtins.bytes
    def __init__(
        self,
        *,
        poll_title: builtins.str | None = ...,
        responses: collections.abc.Iterable[response_pb2.Response] | None = ...,
